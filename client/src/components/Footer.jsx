  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            <img src={assets.logo} alt="logo" className="w-44 object-contain" />
            <p className="mt-6 text-sm">
               Experience the power of Ai with QuickAi. <br /> Transform your content creation with out suit of Premium AI tools. Write articles, generate images and enchace your workflow
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2026 © Vivek. All Right Reserved.
    </p>
</footer>
  )
}
